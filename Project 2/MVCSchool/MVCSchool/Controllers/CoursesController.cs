...
namespace MVCSchool.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseId,CourseName,CourseDescription,TeacherId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseId,CourseName,CourseDescription,TeacherId")] Course course)
        {
            if (ModelState.IsValid)
            {
